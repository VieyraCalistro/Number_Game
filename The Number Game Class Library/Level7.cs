...
namespace The_Number_Game_Class_Library
{
    public class Level7
    {
        ...
        public static void Welcome(int counter1)
        {
            ...
            Console.WriteLine("Welcome to level 7");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine();
            Console.WriteLine("Lets see if you can guess the new number I just thought of, it's a WHOLE number between 1500 and 2000 inclusively, you have " + counter1 + " guesses!");
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("This is where it gets serious!");
            Console.ForegroundColor = ConsoleColor.White;
            ContinueKey();
        }
        ...
        public static void NumberGuessRange()
        {
            ...
            ValidGuess[] previousGuesses = new ValidGuess[12];
            ...
            while (counter > 0)
            {
                ...
                Console.Write("WHOLE ");
                Console.ForegroundColor = ConsoleColor.White;
                Console.Write("number between 1500-2000 inclusively, or type 1000 to exit: ");
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("You can only enter a number between 1500-2000 inclusively, answer is a WHOLE number");
                ...
                else if (number == RR - 6 && number < 2001 && number > 1499)
                {
                ...
                else if (number == RR - 5 && number < 2001 && number > 1499)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 4 && number < 2001 && number > 1499)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 3 && number < 2001 && number > 1499)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                ...
                else if (number == RR - 2 && number < 2001 && number > 1499)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number == RR - 1 && number < 2001 && number > 1499)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number > 2000)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Cyan;
                    Console.WriteLine(number + " :Too high, remember the answer is a Whole number between 1500-2000 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                else if (number < 1500)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine(number + " :Too Low, remember the answer is a Whole number between 1500-2000 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
