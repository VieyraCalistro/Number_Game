...
namespace The_Number_Game_Class_Library
{
    public class Level9
    {
        ...
        public static void Welcome(int counter1)
        {
            ...
            Console.WriteLine("Welcome to level 9");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine();
            Console.WriteLine("Lets see if you can guess the new number I just thought of, it's a WHOLE number either 1 or 2, you have " + counter1 + " guess!");
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Magenta;
            Console.WriteLine("Wild guess!");
            Console.ForegroundColor = ConsoleColor.White;
            ContinueKey();
        }
        ...
        public static void NumberGuessRange()
        {
            ...
            ValidGuess[] previousGuesses = new ValidGuess[2];
            ...
            while (counter > 0)
            {
                ...
                Console.Write("WHOLE ");
                Console.ForegroundColor = ConsoleColor.White;
                Console.Write("number either 1 or 2, or type 1000 to exit: ");
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("You can only enter a number either 1 or 2, answer is a WHOLE number");
                ...
                else if (number == RR - 6 && number < 3 && number > 0)
                {
                ...
                else if (number == RR - 5 && number < 3 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 4 && number < 3 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 3 && number < 3 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                ...
                else if (number == RR - 2 && number < 3 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number == RR - 1 && number < 3 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number > 2)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Cyan;
                    Console.WriteLine(number + " :Too high, remember the answer is a Whole number either 1 or 2 only");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                else if (number < 1)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine(number + " :Too Low, remember the answer is a Whole number either 1 or 2 only");
                    Console.ForegroundColor = ConsoleColor.White;
