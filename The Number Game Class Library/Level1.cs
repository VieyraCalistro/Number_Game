...
namespace The_Number_Game_Class_Library
{
    public class Level1
    {
        ...
        public static void Welcome(int counter1)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Lets see if you can guess the new number I just thought of, it's a WHOLE number between 1 and 50 inclusively, you have\n " + counter1 + " guesses!");
            Console.WriteLine();
            Console.WriteLine("Here's a helpful hint that you can use along the way through the challenging 10 Levels: You can use division to\n increase your chances in choosing the correct number.");
            Console.WriteLine();
        ...
        public static void NumberGuessRange()
        {
            ...
            ValidGuess[] previousGuesses = new ValidGuess[11];
            ...
            while (counter > 0)
            {
                ...
                Console.Write("WHOLE ");
                Console.ForegroundColor = ConsoleColor.White;
                Console.Write("number between 1-50 inclusively, or type 1000 to exit: ");
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("You can only enter a number between 1-50 inclusively, answer is a WHOLE number");
                ...
                else if (number == RR - 6 && number < 51 && number > 0)
                {
                ...
                else if (number == RR - 5 && number < 51 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 4 && number < 51 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 3 && number < 51 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                ...
                else if (number == RR - 2 && number < 51 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number == RR - 1 && number < 51 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number > 50)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Cyan;
                    Console.WriteLine(number + " :Too high, remember the answer is a Whole number between 1-50 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                else if (number < 1)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine(number + " :Too Low, remember the answer is a Whole number between 1-50 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
