...
namespace The_Number_Game_Class_Library
{
    public class Level8
    {
        ...
        public static void Welcome(int counter1)
        {
            ...
            Console.WriteLine("Welcome to level 8");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine();
            Console.WriteLine("Lets see if you can guess the new number I just thought of, it's a WHOLE number between 1 and 13 inclusively, you have " + counter1 + " guesses!");
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("You can see the light at the end of the tunnel!");
            Console.ForegroundColor = ConsoleColor.White;
            ContinueKey();
        }
        ...
        public static void NumberGuessRange()
        {
            ...
            ValidGuess[] previousGuesses = new ValidGuess[5];
            ...
            while (counter > 0)
            {
                ...
                Console.Write("WHOLE ");
                Console.ForegroundColor = ConsoleColor.White;
                Console.Write("number between 1-13 inclusively, or type 1000 to exit: ");
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("You can only enter a number between 1-13 inclusively, answer is a WHOLE number");
                ...
                else if (number == RR - 6 && number < 14 && number > 0)
                {
                ...
                else if (number == RR - 5 && number < 14 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 4 && number < 14 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 3 && number < 14 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                ...
                else if (number == RR - 2 && number < 14 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number == RR - 1 && number < 14 && number > 0)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
