...
namespace The_Number_Game_Class_Library
{
    public class Level10
    {
        ...
        public static void Welcome(int counter1)
        {
            ...
            Console.WriteLine("Welcome to level 10");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine();
            Console.WriteLine("Lets see if you can guess the new number I just thought of, it's a WHOLE number between 1 and 5 inclusively, you have " + counter1 + " guesses!");
            Console.WriteLine();
        ...
        public static void NumberGuessRange()
        {
            ...
            ValidGuess[] previousGuesses = new ValidGuess[3];
            ...
            while (counter > 0)
            {
                ...
                Console.Write("WHOLE ");
                Console.ForegroundColor = ConsoleColor.White;
                Console.Write("number between 1-5 inclusively, or type 1000 to exit: ");
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("You can only enter a number between 1-5 inclusively, answer is a WHOLE number");
                ...
                else if (number == RR)
                {
                    ...
                    Console.WriteLine();
                    Console.BackgroundColor = ConsoleColor.DarkBlue;
                    Console.WriteLine("Congratulations you have mastered The Number Game !!");
                    Console.BackgroundColor = ConsoleColor.Black;
                    Console.WriteLine();
                    Console.WriteLine("Thanks for playing, Goodbye!");
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine("Hint- you should play again !");
                    Console.ForegroundColor = ConsoleColor.White;
                    ContinueKey();
                    Console.ReadKey();
                    Console.Clear();
                ...
                //else if (number == RR - 6 && number < 6 && number > 0)
                //{
                ...
                //}
                //else if (number == RR - 5 && number < 6 && number > 0)
                //{
                //    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                //    Console.WriteLine();
                //    VeryCloseTooLow(number);
                ...
                //}
                //else if (number == RR - 4 && number < 6 && number > 0)
                //{
                //    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                //    Console.WriteLine();
                //    VeryCloseTooLow(number);
                ...
                //}
                //else if (number == RR - 3 && number < 6 && number > 0)
                //{
                //    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                //    Console.WriteLine();
                ...
                //}
                //else if (number == RR - 2 && number < 6 && number > 0)
                //{
                //    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                //    Console.WriteLine();
                //    SuperCLoseTooLow(number);
                ...
                //}
                //else if (number == RR - 1 && number < 6 && number > 0)
                //{
                //    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                //    Console.WriteLine();
                //    SuperCLoseTooLow(number);
                ...
                else if (number > 5)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Cyan;
                    Console.WriteLine(number + " :Too high, remember the answer is a Whole number between 1-13 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                else if (number < 1)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine(number + " :Too Low, remember the answer is a Whole number between 1-13 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                else if (number < RR)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    Console.WriteLine("One more shot at it !");
                    //Console.ForegroundColor = ConsoleColor.Green;
