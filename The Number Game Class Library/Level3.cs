...
namespace The_Number_Game_Class_Library
{
    public class Level3
    {
        ...
        public static void Welcome(int counter1)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Lets see if you can guess the new number I just thought of, it's a WHOLE number between 235 and 335 inclusively, you have " + counter1 + " guesses!");
            Console.WriteLine();
        ...
        public static void NumberGuessRange()
        {
            ...
            while (counter > 0)
            {
                ...
                Console.Write("WHOLE ");
                Console.ForegroundColor = ConsoleColor.White;
                Console.Write("number between 235-335 inclusively, or type 1000 to exit: ");
                ...
                {
                    Console.WriteLine();
                    Console.WriteLine("You can only enter a number between 235-335 inclusively, answer is a WHOLE number");
                ...
                else if (number == RR - 6 && number < 336 && number > 234)
                {
                ...
                else if (number == RR - 5 && number < 336 && number > 234)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 4 && number < 336 && number > 234)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    VeryCloseTooLow(number);
                ...
                else if (number == RR - 3 && number < 336 && number > 234)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                ...
                else if (number == RR - 2 && number < 336 && number > 234)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number == RR - 1 && number < 336 && number > 234)
                {
                    CheckingForRepeatedLowGuesses(ref previousGuesses, number, ref counter);
                    Console.WriteLine();
                    SuperCLoseTooLow(number);
                ...
                else if (number > 335)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Cyan;
                    Console.WriteLine(number + " :Too high, remember the answer is a Whole number between 235-335 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
                ...
                else if (number < 235)
                {
                    Console.WriteLine();
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine(number + " :Too Low, remember the answer is a Whole number between 235-335 inclusively only");
                    Console.ForegroundColor = ConsoleColor.White;
