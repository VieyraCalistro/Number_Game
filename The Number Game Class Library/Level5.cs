...
namespace The_Number_Game_Class_Library
{
    public class Level5
    {
        ...
        public static void Welcome(int counter1)
        {
            ...
            Console.WriteLine("Welcome to level 5");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine();
            Console.WriteLine("Lets see if you can guess the new number I just thought of, it's a WHOLE number between 1 and 150 inclusively, you have " + counter1 + " guesses!");
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Gray;
            Console.WriteLine("You are half way there!");
            Console.ForegroundColor = ConsoleColor.White;
            ContinueKey();
        }
